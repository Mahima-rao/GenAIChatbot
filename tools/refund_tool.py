...
# # #         if not order_id:
# # #             return "I couldn't find the order you're referring to. Please specify your order ID."
# # #         if order["user_id"] != user_id:
# # #             return f"Order {order_id} does not belong to you. Please check the order number."


# # #         return f"Refund for order {order_id} is currently being processed."
...
# #         return {"success": True, "message": f"Refund for order {order_id} is currently being processed.", "policy_id": None}
# from tools.base_tool import BaseTool
# from api.orders_db import get_order
